...
DEFAULT_SUMMARY_ROOT = REPO_ROOT / "experiments/stage121_broader_rendered_compressed_deterministic_validation"
...
from scripts.run_stage120_rendered_compressed_deterministic_shortlist import (  # noqa: E402
    GROUP_SUMMARY_FIELDS,
    ROW_FIELDS,
    SETTING_SUMMARY_FIELDS,
    average,
    build_main_rate_lookup,
    endpoint_diff_indices,
    format_float,
    read_csv,
...
def main():
    ...
    if policy["selected_candidate"] != "endpoint_diff_baseline":
        raise ValueError("Stage121 broader validation expects the Stage114 endpoint-diff selector")
    ...
    rows_csv = args.summary_root / "stage121_broader_rendered_compressed_deterministic_validation_rows.csv"
    group_summary_csv = args.summary_root / "stage121_broader_rendered_compressed_deterministic_validation_group_summary.csv"
    setting_summary_csv = args.summary_root / "stage121_broader_rendered_compressed_deterministic_validation_setting_summary.csv"
    summary_json = args.summary_root / "stage121_broader_rendered_compressed_deterministic_validation_summary.json"
    report_md = args.summary_root / "stage121_broader_rendered_compressed_deterministic_validation_report.md"
    ...
    summary = {
        "stage": 121,
        "mode": "broader rendered compressed deterministic validation",
        ...
        "notes": [
            "Broader rendered validation uses teacher-derived residual values from dense target anchors.",
            "All compressed deterministic side-info bytes are counted in direct and amortized total rates.",
            "q6_top10 is the same-task quality anchor for deltas.",
        ],
    }
